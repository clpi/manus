/* Generated by duo compiler â€” do not edit */
...
/* Result and Option type aliases â€” semantics: non-nil = ok/some */
...
static inline bool is_absolute(const char* p);
static lua_Value is_absolute__lua(lua_Value _a0);
static inline const char* normalize(const char* p);
static lua_Value normalize__lua(lua_Value _a0);
static inline const char* join(const char* a, const char* b) {
    if ((a == "")) {
        return b;
    }
    ...
    if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(b), lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)(1))))), lua_val_from_literal("/", 705468254, 1))) {
        return b;
    }
    if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(a), lua_val_from_int((int64_t)((-1))), lua_val_from_int((int64_t)((-1)))))), lua_val_from_literal("/", 705468254, 1))) {
...
static inline const char* basename(const char* p) {
    ...
    lua_Value i = lua_val_from_int((int64_t)(((int64_t)strlen(p))));
    while ((lua_gt(i, lua_val_from_int((int64_t)(1))) && lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(p), i, i))), lua_val_from_literal("/", 705468254, 1)))) {
                i = lua_sub(i, lua_val_from_int((int64_t)(1)));
    }
    lua_Value last = i;
    while ((lua_gt(i, lua_val_from_int((int64_t)(1))) && lua_neq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(p), lua_sub(i, lua_val_from_int((int64_t)(1))), lua_sub(i, lua_val_from_int((int64_t)(1)))))), lua_val_from_literal("/", 705468254, 1)))) {
                i = lua_sub(i, lua_val_from_int((int64_t)(1)));
    }
...
static inline const char* dirname(const char* p) {
    ...
    if (lua_leq(i, lua_val_from_int((int64_t)(1)))) {
        if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(p), lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)(1))))), lua_val_from_literal("/", 705468254, 1))) {
            return "/";
        }
        return ".";
    }
...
static inline const char* extname(const char* p) {
    lua_Value base = lua_val_from_str(basename(p));
    lua_Value i = lua_val_from_int((int64_t)(((int64_t)strlen(lua_to_str(base)))));
    while (lua_gt(i, lua_val_from_int((int64_t)(1)))) {
        if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(base, i, i))), lua_val_from_literal(".", 722245873, 1))) {
...
static inline bool is_absolute(const char* p) {
    if ((lua_eq(lua_val_from_str(p), lua_val_nil()) || (p == ""))) {
        return false;
    }
    return lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(p), lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)(1))))), lua_val_from_literal("/", 705468254, 1));
}

static lua_Value is_absolute__lua(lua_Value _a0) {
const char* _p0 = lua_to_str(_a0);
bool _r = is_absolute(_p0);
...
static inline const char* normalize(const char* p) {
    ...
    while (lua_to_bool(lua_str_find(lua_val_from_str(p), lua_val_from_literal("//", 2731697891, 2)))) {
                duo_release((void*)(p));
        p = lua_to_str(lua_str_gsub(lua_val_from_str(p), lua_val_from_literal("//", 2731697891, 2), lua_val_from_literal("/", 705468254, 1)));
        duo_retain((void*)(p));
    }
    if (((p != "/") && lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(lua_val_from_str(p), lua_val_from_int((int64_t)((-1))), lua_val_from_int((int64_t)((-1)))))), lua_val_from_literal("/", 705468254, 1)))) {
                duo_release((void*)(p));
        p = lua_to_str(lua_str_sub(lua_val_from_str(p), lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)((-2)))));
        duo_retain((void*)(p));
    }
    return p;
}
...
static lua_Value duo_mod_std_path(lua_Value _unused) {
    ...
    lua_table_set(M, lua_val_from_str("is_absolute"), lua_val_from_func((lua_Value (*)(lua_Value))is_absolute__lua));
    lua_table_set(M, lua_val_from_str("normalize"), lua_val_from_func((lua_Value (*)(lua_Value))normalize__lua));
    return M;
}
...
static inline const char* get(const char* name) {
    lua_Value v = lua_os_getenv(lua_val_from_str(name));
...
static inline int64_t exec(const char* cmd) {
    lua_Value rc = lua_os_execute(lua_val_from_str(cmd));
    if (lua_eq(rc, lua_val_nil())) {
        return (-1);
    }
    return (int64_t)lua_to_num(rc);
}
...
static inline const char* capture(const char* cmd) {
    lua_Value f = lua_io_popen(lua_val_from_str(cmd), lua_val_from_literal("r", 4144776981, 1));
    if (lua_eq(f, lua_val_nil())) {
        return "";
    }
    lua_Value out = lua_val_from_literal("", 2166136261, 0);
    lua_Value line = lua_file_read_method(f);
...
static inline void list_insert(lua_Value list, int64_t index, lua_Value value);
static lua_Value list_insert__lua3(lua_Value _a0, lua_Value _a1, lua_Value _a2);
static inline void list_clear(lua_Value list);
static lua_Value list_clear__lua(lua_Value _a0);
static inline void map_delete(lua_Value m, lua_Value key);
static lua_Value map_delete__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value map_keys(lua_Value m);
static lua_Value map_keys__lua(lua_Value _a0);
static inline lua_Value map_values(lua_Value m);
static lua_Value map_values__lua(lua_Value _a0);
static inline void set_remove(lua_Value s, lua_Value value);
static lua_Value set_remove__lua2(lua_Value _a0, lua_Value _a1);
static inline void set_clear(lua_Value s);
static lua_Value set_clear__lua(lua_Value _a0);
static inline lua_Value set_union(lua_Value s1, lua_Value s2);
static lua_Value set_union__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value set_intersection(lua_Value s1, lua_Value s2);
static lua_Value set_intersection__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value set_difference(lua_Value s1, lua_Value s2);
static lua_Value set_difference__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value list_new() {
    return ({
        lua_Value tmp = lua_table_new_with_capacity(0, 0);
        tmp;
...
static inline void list_push(lua_Value list, lua_Value value) {
    lua_tbl_insert(list, value, lua_val_nil());
}
...
static inline int64_t list_len(lua_Value list) {
    return (int64_t)lua_to_num(lua_len(list));
}
...
static inline void stack_push(lua_Value stack, lua_Value value) {
    lua_tbl_insert(stack, value, lua_val_nil());
}
...
static inline void queue_enqueue(lua_Value q, lua_Value value) {
    lua_tbl_insert(q, value, lua_val_nil());
}
...
static inline bool is_array(lua_Value t) {
    if (lua_neq(lua_val_from_str(type(t)), lua_val_from_literal("table", 1251777503, 5))) {
        return false;
    }
    if (lua_eq(lua_table_get(t, lua_val_from_int((int64_t)(1))), lua_val_nil())) {
        return true;
    }
    lua_Value i = lua_val_from_int((int64_t)(2));
    ...
    }
    {
        ...
        if (tbl.type == VAL_TABLE) {
            ...
            for (int idx = 0; idx < t_ptr->array_size; idx++) {
                ...
                if (lua_neq(lua_val_from_str(type(k)), lua_val_from_literal("number", 467038368, 6))) {
                    return false;
                }
...
static inline void list_insert(lua_Value list, int64_t index, lua_Value value) {
    lua_tbl_insert(list, lua_val_from_int((int64_t)(index)), value);
}
...
static inline void list_clear(lua_Value list) {
    ...
    lua_Value i = lua_len(list);
    while (lua_gt(i, lua_val_from_int((int64_t)(0)))) {
        lua_tbl_remove(list, i);
                i = lua_sub(i, lua_val_from_int((int64_t)(1)));
    }
}
...
static inline void map_delete(lua_Value m, lua_Value key) {
    if (lua_eq(m, lua_val_nil())) {
        return;
    }
    lua_table_set(m, key, lua_val_nil());
}
    ...
    }
    {
        ...
        if (tbl.type == VAL_TABLE) {
            ...
            for (int idx = 0; idx < t_ptr->array_size; idx++) {
                ...
                lua_Value k = lua_val_from_num((double)(idx + 1));
                lua_Value _ = t_ptr->array[idx];
                return lua_tbl_insert(out, k, lua_val_nil());
            }
            for (int idx = 0; idx < t_ptr->capacity; idx++) {
                if (t_ptr->entries[idx].key.type == VAL_NIL) continue;
                lua_Value k = t_ptr->entries[idx].key;
    ...
    }
    {
        ...
        if (tbl.type == VAL_TABLE) {
            ...
            for (int idx = 0; idx < t_ptr->array_size; idx++) {
                ...
                return lua_tbl_insert(out, v, lua_val_nil());
            }
            for (int idx = 0; idx < t_ptr->capacity; idx++) {
                if (t_ptr->entries[idx].key.type == VAL_NIL) continue;
...
static inline void set_remove(lua_Value s, lua_Value value) {
    ...
    lua_table_set(s, value, lua_val_nil());
}
    ...
    if (lua_neq(s1, lua_val_nil())) {
        {
            ...
            if (tbl.type == VAL_TABLE) {
                ...
                for (int idx = 0; idx < t_ptr->array_size; idx++) {
                    ...
                    lua_Value k = lua_val_from_num((double)(idx + 1));
                    lua_Value _ = t_ptr->array[idx];
                    lua_table_set(out, k, lua_val_from_bool(true));
                }
                for (int idx = 0; idx < t_ptr->capacity; idx++) {
                    if (t_ptr->entries[idx].key.type == VAL_NIL) continue;
                    lua_Value k = t_ptr->entries[idx].key;
...
lua_Value _p0 = _a0;
lua_Value _p1 = _a1;
lua_Value _r = set_union(_p0, _p1);
    return _r;
}
...
static inline lua_Value set_intersection(lua_Value s1, lua_Value s2) {
    ...
    if ((lua_eq(s1, lua_val_nil()) || lua_eq(s2, lua_val_nil()))) {
        return out;
    }
    {
        lua_Value tbl = s1;
        if (tbl.type == VAL_TABLE) {
            ...
            for (int idx = 0; idx < t_ptr->array_size; idx++) {
                ...
                lua_Value k = lua_val_from_num((double)(idx + 1));
                lua_Value _ = t_ptr->array[idx];
                if (lua_neq(lua_table_get(s2, k), lua_val_nil())) {
                    lua_table_set(out, k, lua_val_from_bool(true));
                }
            }
            for (int idx = 0; idx < t_ptr->capacity; idx++) {
...
lua_Value _p0 = _a0;
lua_Value _p1 = _a1;
lua_Value _r = set_intersection(_p0, _p1);
    return _r;
}
    ...
    }
    {
        ...
        if (tbl.type == VAL_TABLE) {
            ...
            for (int idx = 0; idx < t_ptr->array_size; idx++) {
                ...
                lua_Value k = lua_val_from_num((double)(idx + 1));
                lua_Value _ = t_ptr->array[idx];
                if ((lua_eq(s2, lua_val_nil()) || lua_eq(lua_table_get(s2, k), lua_val_nil()))) {
                    lua_table_set(out, k, lua_val_from_bool(true));
                }
            }
            for (int idx = 0; idx < t_ptr->capacity; idx++) {
...
lua_Value _p0 = _a0;
lua_Value _p1 = _a1;
lua_Value _r = set_difference(_p0, _p1);
    return _r;
}
...
static lua_Value duo_mod_std_collections(lua_Value _unused) {
    ...
    lua_table_set(M, lua_val_from_str("list_insert"), lua_val_from_func((void*)list_insert__lua3));
    lua_table_set(M, lua_val_from_str("list_clear"), lua_val_from_func((lua_Value (*)(lua_Value))list_clear__lua));
    ...
    lua_table_set(M, lua_val_from_str("map_delete"), lua_val_from_func((void*)map_delete__lua2));
    lua_table_set(M, lua_val_from_str("map_keys"), lua_val_from_func((lua_Value (*)(lua_Value))map_keys__lua));
    lua_table_set(M, lua_val_from_str("map_values"), lua_val_from_func((lua_Value (*)(lua_Value))map_values__lua));
    ...
    lua_table_set(M, lua_val_from_str("set_remove"), lua_val_from_func((void*)set_remove__lua2));
    lua_table_set(M, lua_val_from_str("set_clear"), lua_val_from_func((lua_Value (*)(lua_Value))set_clear__lua));
    lua_table_set(M, lua_val_from_str("set_union"), lua_val_from_func((void*)set_union__lua2));
    lua_table_set(M, lua_val_from_str("set_intersection"), lua_val_from_func((void*)set_intersection__lua2));
    lua_table_set(M, lua_val_from_str("set_difference"), lua_val_from_func((void*)set_difference__lua2));
...
static inline duo_closure_0* duo_make_closure_0(lua_Value up0, lua_Value up1, lua_Value up2) {
    duo_closure_0* cl = (duo_closure_0*)malloc(sizeof(duo_closure_0));
    cl->header.refcount = 1;
    cl->header.type_tag = VAL_CLOSURE;
    cl->id = 0;
    cl->nup = 3;
    cl->up0 = up0;
    cl->up1 = up1;
...
static void duo_free_closure_0(duo_closure_0* cl) {
    free(cl);
}

static lua_Value duo_cl_0(lua_Closure* cl, int argc, lua_Value* argv);
...
static void spawn(lua_Value fn) {
    ...
    lua_Value co = lua_co_create(lua_val_from_closure((lua_Closure*)duo_make_closure_0(fn, table, args_list)));
...
static inline void run() {
    while (lua_gt(lua_len(_run_queue), lua_val_from_int((int64_t)(0)))) {
        lua_Value task = lua_tbl_remove(_run_queue, lua_val_from_int((int64_t)(1)));
                lua_mret_clear();
        ok = lua_co_resume(lua_table_get(task, lua_val_from_literal("co", 1646896135, 2)), lua_val_nil());
        err = lua_mret_get(0);
        if ((!lua_to_bool(ok))) {
            lua_io_write(lua_val_from_str(lua_concat(lua_val_from_literal("sync: task error: ", 204803405, 18), lua_val_from_str(lua_concat(lua_val_from_str(lua_to_str(tostring(err))), lua_val_from_literal("\n", 252472541, 1))))), lua_val_nil(), lua_val_nil(), lua_val_nil());
...
static inline bool step() {
    ...
    err = lua_mret_get(0);
    if ((!lua_to_bool(ok))) {
        return lua_to_bool(lua_io_write(lua_val_from_str(lua_concat(lua_val_from_literal("sync: task error: ", 204803405, 18), lua_val_from_str(lua_concat(lua_val_from_str(lua_to_str(tostring(err))), lua_val_from_literal("\n", 252472541, 1))))), lua_val_nil(), lua_val_nil(), lua_val_nil()));
    } else if (lua_eq(lua_co_status(lua_table_get(task, lua_val_from_literal("co", 1646896135, 2))), lua_val_from_literal("suspended", 205403298, 9))) {
        lua_table_set(_run_queue, lua_add(lua_len(_run_queue), lua_val_from_int((int64_t)(1))), task);
    }
...
static inline void channel_send(lua_Value ch, lua_Value val) {
    if (lua_to_bool(lua_table_get(ch, lua_val_from_literal("_closed", 3242855962, 7)))) {
        lua_error(lua_val_from_literal("send on closed channel", 1438178659, 22));
    }
    if (lua_gt(lua_len(lua_table_get(ch, lua_val_from_literal("_recv_waiters", 1747035374, 13))), lua_val_from_int((int64_t)(0)))) {
        lua_Value w = lua_tbl_remove(lua_table_get(ch, lua_val_from_literal("_recv_waiters", 1747035374, 13)), lua_val_from_int((int64_t)(1)));
...
static inline lua_Value channel_recv(lua_Value ch) {
    if (lua_gt(lua_len(lua_table_get(ch, lua_val_from_literal("_queue", 305733561, 6))), lua_val_from_int((int64_t)(0)))) {
        lua_Value val = lua_tbl_remove(lua_table_get(ch, lua_val_from_literal("_queue", 305733561, 6)), lua_val_from_int((int64_t)(1)));
        if (lua_gt(lua_len(lua_table_get(ch, lua_val_from_literal("_send_waiters", 2095185160, 13))), lua_val_from_int((int64_t)(0)))) {
            lua_Value w = lua_tbl_remove(lua_table_get(ch, lua_val_from_literal("_send_waiters", 2095185160, 13)), lua_val_from_int((int64_t)(1)));
...
static inline lua_Value std_net_connect(const char* host, int64_t port);
static lua_Value std_net_connect__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value std_net_listen(const char* host, int64_t port, int64_t backlog);
static lua_Value std_net_listen__lua3(lua_Value _a0, lua_Value _a1, lua_Value _a2);
static inline lua_Value std_net_accept(lua_Value srv_fd);
static lua_Value std_net_accept__lua(lua_Value _a0);
static inline int64_t std_net_send(lua_Value fd, const char* data);
static lua_Value std_net_send__lua2(lua_Value _a0, lua_Value _a1);
static inline lua_Value std_net_recv(lua_Value fd, int64_t maxlen);
static lua_Value std_net_recv__lua2(lua_Value _a0, lua_Value _a1);
static inline void std_net_close(lua_Value fd);
static lua_Value std_net_close__lua(lua_Value _a0);
...
static inline lua_Value parse_url(const char* url) {
    lua_Value scheme = lua_val_from_literal("http", 3378792613, 4);
    lua_Value rest = lua_val_from_str(url);
    if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(rest, lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)(7))))), lua_val_from_literal("http://", 557233483, 7))) {
                rest = lua_val_from_str(lua_to_str(lua_str_sub(rest, lua_val_from_int((int64_t)(8)), lua_val_nil())));
    } else if (lua_eq(lua_val_from_str(lua_to_str(lua_str_sub(rest, lua_val_from_int((int64_t)(1)), lua_val_from_int((int64_t)(8))))), lua_val_from_literal("https://", 2091329406, 8))) {
                scheme = lua_val_from_literal("https", 3739134178, 5);
                rest = lua_val_from_str(lua_to_str(lua_str_sub(rest, lua_val_from_int((int64_t)(9)), lua_val_nil())));
    }
    if (lua_eq(scheme, lua_val_from_literal("https", 3739134178, 5))) {
        lua_Value default_port = lua_val_from_int((int64_t)(443));
    } else {
        lua_Value default_port = lua_val_from_int((int64_t)(80));
    }
    lua_Value host = rest;
    lua_Value path = lua_val_from_literal("/", 705468254, 1);
    lua_Value slash_pos = lua_str_find(rest, lua_val_from_literal("/", 705468254, 1));
    if (lua_to_bool(slash_pos)) {
                host = lua_val_from_str(lua_to_str(lua_str_sub(rest, lua_val_from_int((int64_t)(1)), lua_sub(slash_pos, lua_val_from_int((int64_t)(1))))));
                path = lua_val_from_str(lua_to_str(lua_str_sub(rest, slash_pos, lua_val_nil())));
    }
    lua_Value colon_pos = lua_str_find(host, lua_val_from_literal(":", 1057798253, 1));
    lua_Value port = default_port;
    if (lua_to_bool(colon_pos)) {
                port = lua_or(tonumber(lua_val_from_str(lua_to_str(lua_str_sub(host, lua_add(colon_pos, lua_val_from_int((int64_t)(1))), lua_val_nil())))), default_port);
                host = lua_val_from_str(lua_to_str(lua_str_sub(host, lua_val_from_int((int64_t)(1)), lua_sub(colon_pos, lua_val_from_int((int64_t)(1))))));
    }
    return ({
...
static inline const char* http_get(const char* url) {
    lua_Value f = lua_io_popen(lua_val_from_str(lua_concat(lua_val_from_literal("curl -sL --max-time 30 -- ", 3248366172, 26), lua_val_from_str(url))), lua_val_from_literal("r", 4144776981, 1));
    if (lua_eq(f, lua_val_nil())) {
        return "";
    }
    lua_Value body = lua_or(lua_file_read_method(f), lua_val_from_literal("", 2166136261, 0));
    lua_io_close(f);
    return lua_to_str(body);
}
...
static inline const char* http_post(const char* url, const char* body, const char* content_type) {
    lua_Value ct = lua_val_from_str(content_type);
    if (lua_eq(ct, lua_val_nil())) {
                ct = lua_val_from_literal("application/x-www-form-urlencoded", 4016200393, 33);
    }
    if (lua_eq(lua_val_from_str(body), lua_val_nil())) {
                duo_release((void*)(body));
        body = "";
        duo_retain((void*)(body));
    }
    lua_Value escaped = lua_str_gsub(lua_val_from_str(body), lua_val_from_literal("'", 571247302, 1), lua_val_from_literal("'\\''", 4086720292, 4));
    lua_Value cmd = lua_val_from_str(lua_concat(lua_val_from_literal("curl -sL --max-time 30 -X POST", 528294947, 30), lua_val_from_str(lua_concat(lua_val_from_literal(" -H 'Content-Type: ", 1158969177, 19), lua_val_from_str(lua_concat(ct, lua_val_from_str(lua_concat(lua_val_from_literal("'", 571247302, 1), lua_val_from_str(lua_concat(lua_val_from_literal(" --data '", 1498539212, 9), lua_val_from_str(lua_concat(escaped, lua_val_from_str(lua_concat(lua_val_from_literal("' -- ", 2561279328, 5), lua_val_from_str(url)))))))))))))));
    lua_Value f = lua_io_popen(cmd, lua_val_from_literal("r", 4144776981, 1));
    if (lua_eq(f, lua_val_nil())) {
        return "";
    }
    lua_Value resp = lua_or(lua_file_read_method(f), lua_val_from_literal("", 2166136261, 0));
    lua_io_close(f);
    return lua_to_str(resp);
}
...
static inline lua_Value http_request(const char* method, const char* url, const char* body, lua_Value headers) {
    lua_Value cmd = lua_val_from_str(lua_concat(lua_val_from_literal("curl -si --max-time 30 -X ", 3131245102, 26), lua_val_from_str(method)));
    ...
    if (lua_to_bool(lua_and(lua_val_from_str(body), lua_val_from_bool((body != ""))))) {
        lua_Value escaped = lua_str_gsub(lua_val_from_str(body), lua_val_from_literal("'", 571247302, 1), lua_val_from_literal("'\\''", 4086720292, 4));
    ...
    lua_Value raw = lua_or(lua_file_read_method(f), lua_val_from_literal("", 2166136261, 0));
    lua_io_close(f);
    lua_Value status = lua_or(tonumber(({
    ...
    lua_Value sep = lua_str_find(raw, lua_val_from_literal("\r\n\r\n", 2327769681, 4));
    lua_Value resp_b = raw;
    if (lua_to_bool(sep)) {
                resp_b = lua_val_from_str(lua_to_str(lua_str_sub(raw, lua_add(sep, lua_val_from_int((int64_t)(4))), lua_val_nil())));
    }
    return ({
        lua_Value tmp = lua_table_new_with_capacity(0, 2);
...
const char* _p0 = lua_to_str(_a0);
int64_t _p1 = (int64_t)lua_to_num(_a1);
lua_Value _r = std_net_connect(_p0, _p1);
    return _r;
}
...
lua_Value _r = std_net_listen(_p0, _p1, _p2);
    return _r;
}
...
static lua_Value std_net_accept__lua(lua_Value _a0) {
lua_Value _p0 = _a0;
lua_Value _r = std_net_accept(_p0);
    return _r;
}
...
lua_Value _p0 = _a0;
const char* _p1 = lua_to_str(_a1);
int64_t _r = std_net_send(_p0, _p1);
    return lua_val_from_num((double)(_r));
}
...
lua_Value _p0 = _a0;
int64_t _p1 = (int64_t)lua_to_num(_a1);
lua_Value _r = std_net_recv(_p0, _p1);
    return _r;
}
...
static inline void http_serve(int64_t port, lua_Value handler) {
    lua_Value srv = std_net_listen("0.0.0.0", port, 128);
    if (lua_eq(srv, lua_val_nil())) {
        lua_io_write(lua_val_from_str(lua_concat(lua_val_from_literal("net.http_serve: listen failed on port ", 2186454048, 38), lua_val_from_str(lua_concat(lua_val_from_str(lua_to_str(tostring(lua_val_from_int((int64_t)(port))))), lua_val_from_literal("\n", 252472541, 1))))), lua_val_nil(), lua_val_nil(), lua_val_nil());
    }
    lua_io_write(lua_val_from_str(lua_concat(lua_val_from_literal("net: listening on :", 189546034, 19), lua_val_from_str(lua_concat(lua_val_from_str(lua_to_str(tostring(lua_val_from_int((int64_t)(port))))), lua_val_from_literal("\n", 252472541, 1))))), lua_val_nil(), lua_val_nil(), lua_val_nil());
    while (true) {
        lua_Value cli = std_net_accept(srv);
        if (lua_eq(cli, lua_val_nil())) {
            break;
        }
        lua_Value raw = std_net_recv(cli, 16384);
        if (lua_neq(raw, lua_val_nil())) {
            lua_Value method = lua_val_from_literal("", 2166136261, 0);
            lua_Value req_path = lua_val_from_literal("", 2166136261, 0);
                        lua_mret_clear();
            method = ({
                lua_Value __fn = lua_table_get(string, lua_val_from_literal("match", 2116038550, 5));
            ...
            lua_Value resp_body = lua_or(({
                lua_Value __fn = handler;
                lua_Value __argv[3] = {method, req_path, raw};
                lua_invoke(__fn, 3, __argv);
            }), lua_val_from_literal("", 2166136261, 0));
            lua_Value response = lua_val_from_str(lua_concat(lua_val_from_literal("HTTP/1.0 200 OK\r\n", 636239182, 17), lua_val_from_str(lua_concat(lua_val_from_literal("Content-Type: text/plain\r\n", 2478622452, 26), lua_val_from_str(lua_concat(lua_val_from_literal("Content-Length: ", 2444759519, 16), lua_val_from_str(lua_concat(lua_val_from_str(lua_to_str(tostring(lua_len(resp_body)))), lua_val_from_str(lua_concat(lua_val_from_literal("\r\n", 2105408918, 2), lua_val_from_str(lua_concat(lua_val_from_literal("Connection: close\r\n\r\n", 346165661, 21), resp_body))))))))))));
...
static lua_Value duo_mod_std_net(lua_Value _unused) {
    ...
    lua_table_set(M, lua_val_from_str("connect"), lua_val_from_func((void*)std_net_connect__lua2));
    lua_table_set(M, lua_val_from_str("listen"), lua_val_from_func((void*)std_net_listen__lua3));
    lua_table_set(M, lua_val_from_str("accept"), lua_val_from_func((lua_Value (*)(lua_Value))std_net_accept__lua));
    lua_table_set(M, lua_val_from_str("send"), lua_val_from_func((void*)std_net_send__lua2));
    lua_table_set(M, lua_val_from_str("recv"), lua_val_from_func((void*)std_net_recv__lua2));
    lua_table_set(M, lua_val_from_str("close"), lua_val_from_func((lua_Value (*)(lua_Value))std_net_close__lua));
...
lua_Value duo_invoke_closure(int id, lua_Closure* cl, int argc, lua_Value* argv) {
    switch (id) {
        case 0: return duo_cl_0(cl, argc, argv);
...
void duo_free_closure(lua_Closure* cl) {
    switch (cl->id) {
        case 0: duo_free_closure_0((duo_closure_0*)cl); return;
        default: free(cl); return;
    }
}

static lua_Value duo_cl_0(lua_Closure* cl_raw, int argc, lua_Value* argv) {
    duo_closure_0* cl = (duo_closure_0*)cl_raw;
    return ({
        lua_Value __fn = cl->up0;
        lua_Value __argv[1] = {({
            lua_Value __fn = lua_table_get(cl->up1, lua_val_from_literal("ªªªªªª", 1203982229, 6));
            lua_Value __argv[1] = {cl->up2};
...
int main(void) {
    ...
    _VERSION = lua_val_from_str("Lua 5.5");
        path = lua_require(lua_val_from_literal("std.path", 3503267747, 8));
        env = lua_require(lua_val_from_literal("std.env", 540956979, 7));
        proc = lua_require(lua_val_from_literal("std.proc", 4228457060, 8));
        collections = lua_require(lua_val_from_literal("std.collections", 285322705, 15));
        sync = lua_require(lua_val_from_literal("std.sync", 3610404343, 8));
        net = lua_require(lua_val_from_literal("std.net", 4053525759, 7));
    printf("%s\n", "=== std.path ===");
    printf("%s\t%s\n", "join:", lua_to_str(({
        lua_Value __fn = lua_table_get(path, lua_val_from_literal("join", 3374496889, 4));
        lua_Value __argv[2] = {lua_val_from_literal("/usr", 2385443452, 4), lua_val_from_literal("bin", 1523243198, 3)};
        lua_invoke(__fn, 2, __argv);
    })));
    printf("%s\t%s\n", "basename:", lua_to_str(({
        lua_Value __fn = lua_table_get(path, lua_val_from_literal("basename", 127185211, 8));
        lua_Value __argv[1] = {lua_val_from_literal("/usr/bin/gcc", 3804990926, 12)};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\t%s\n", "dirname:", lua_to_str(({
        lua_Value __fn = lua_table_get(path, lua_val_from_literal("dirname", 3437940111, 7));
        lua_Value __argv[1] = {lua_val_from_literal("/usr/bin/gcc", 3804990926, 12)};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\t%s\n", "extname:", lua_to_str(({
        lua_Value __fn = lua_table_get(path, lua_val_from_literal("extname", 510771567, 7));
        lua_Value __argv[1] = {lua_val_from_literal("/usr/bin/gcc", 3804990926, 12)};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\n", "=== std.env ===");
    printf("%s\t%s\n", "has PATH:", lua_to_str(({
        lua_Value __fn = lua_table_get(env, lua_val_from_literal("has", 3988721635, 3));
        lua_Value __argv[1] = {lua_val_from_literal("PATH", 1839435638, 4)};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\t%lld\n", "get PATH len:", ((int64_t)strlen(lua_to_str(({
        lua_Value __fn = lua_table_get(env, lua_val_from_literal("get", 1410115415, 3));
        lua_Value __argv[1] = {lua_val_from_literal("PATH", 1839435638, 4)};
        lua_invoke(__fn, 1, __argv);
    })))));
    printf("%s\n", "=== std.collections ===");
        list = ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_new", 1809217604, 8));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_push", 1393581034, 9));
        lua_Value __argv[2] = {list, lua_val_from_literal("a", 3826002220, 1)};
        lua_invoke(__fn, 2, __argv);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_push", 1393581034, 9));
        lua_Value __argv[2] = {list, lua_val_from_literal("b", 3876335077, 1)};
        lua_invoke(__fn, 2, __argv);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_push", 1393581034, 9));
        lua_Value __argv[2] = {list, lua_val_from_literal("c", 3859557458, 1)};
        lua_invoke(__fn, 2, __argv);
    });
    printf("%s\t%s\n", "list len:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_len", 804587441, 8));
        lua_Value __argv[1] = {list};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\t%s\n", "list pop:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("list_pop", 452517385, 8));
        lua_Value __argv[1] = {list};
        lua_invoke(__fn, 1, __argv);
    })));
        stack = ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("stack_new", 2491477886, 9));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("stack_push", 634959876, 10));
        lua_Value __argv[2] = {stack, lua_val_from_int((int64_t)(1))};
        lua_invoke(__fn, 2, __argv);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("stack_push", 634959876, 10));
        lua_Value __argv[2] = {stack, lua_val_from_int((int64_t)(2))};
        lua_invoke(__fn, 2, __argv);
    });
    printf("%s\t%s\n", "stack pop:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("stack_pop", 1892229063, 9));
        lua_Value __argv[1] = {stack};
        lua_invoke(__fn, 1, __argv);
    })));
        queue = ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("queue_new", 2705625201, 9));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("queue_enqueue", 2649997245, 13));
        lua_Value __argv[2] = {queue, lua_val_from_literal("x", 4245442695, 1)};
        lua_invoke(__fn, 2, __argv);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("queue_enqueue", 2649997245, 13));
        lua_Value __argv[2] = {queue, lua_val_from_literal("y", 4228665076, 1)};
        lua_invoke(__fn, 2, __argv);
    });
    printf("%s\t%s\n", "queue dequeue:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("queue_dequeue", 9094885, 13));
        lua_Value __argv[1] = {queue};
        lua_invoke(__fn, 1, __argv);
    })));
        map = ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("map_new", 3004831476, 7));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("map_set", 2736094442, 7));
        lua_Value __argv[3] = {map, lua_val_from_literal("key", 1746258028, 3), lua_val_from_literal("value", 1113510858, 5)};
        lua_invoke(__fn, 3, __argv);
    });
    printf("%s\t%s\n", "map get:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("map_get", 2006148294, 7));
        lua_Value __argv[2] = {map, lua_val_from_literal("key", 1746258028, 3)};
        lua_invoke(__fn, 2, __argv);
    })));
    printf("%s\t%s\n", "map has:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("map_has", 3413873858, 7));
        lua_Value __argv[2] = {map, lua_val_from_literal("key", 1746258028, 3)};
        lua_invoke(__fn, 2, __argv);
    })));
        set = ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("set_new", 1181896754, 7));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("set_add", 877620719, 7));
        lua_Value __argv[2] = {set, lua_val_from_int((int64_t)(42))};
        lua_invoke(__fn, 2, __argv);
    });
    printf("%s\t%s\n", "set has 42:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("set_has", 866881716, 7));
        lua_Value __argv[2] = {set, lua_val_from_int((int64_t)(42))};
        lua_invoke(__fn, 2, __argv);
    })));
    printf("%s\t%s\n", "set has 99:", lua_to_str(({
        lua_Value __fn = lua_table_get(collections, lua_val_from_literal("set_has", 866881716, 7));
        lua_Value __argv[2] = {set, lua_val_from_int((int64_t)(99))};
        lua_invoke(__fn, 2, __argv);
    })));
    printf("%s\n", "=== std.sync ===");
        ch = ({
        lua_Value __fn = lua_table_get(sync, lua_val_from_literal("channel_new", 3381666957, 11));
                lua_invoke(__fn, 0, NULL);
    });
    ({
        lua_Value __fn = lua_table_get(sync, lua_val_from_literal("channel_send", 2734040403, 12));
        lua_Value __argv[2] = {ch, lua_val_from_literal("hello", 1335831723, 5)};
        lua_invoke(__fn, 2, __argv);
    });
    printf("%s\t%s\n", "channel recv:", lua_to_str(({
        lua_Value __fn = lua_table_get(sync, lua_val_from_literal("channel_recv", 3259713225, 12));
        lua_Value __argv[1] = {ch};
        lua_invoke(__fn, 1, __argv);
    })));
    printf("%s\n", "=== std.net ===");
    printf("%s\t%s\n", "tcp_connect stub:", lua_to_str(({
        lua_Value __fn = lua_table_get(net, lua_val_from_literal("tcp_connect", 2112516113, 11));
        lua_Value __argv[2] = {lua_val_from_literal("example.com", 1125968678, 11), lua_val_from_int((int64_t)(80))};
        lua_invoke(__fn, 2, __argv);
    })));
    printf("%s\n", "=== std.proc ===");
    printf("%s\t%s\n", "whoami:", lua_to_str(({
        lua_Value __fn = lua_table_get(proc, lua_val_from_literal("capture", 4237826497, 7));
        lua_Value __argv[1] = {lua_val_from_literal("whoami", 3131618372, 6)};
        lua_invoke(__fn, 1, __argv);
    })));
