...
- Scope every frontier claim by axes, semantics, corpus/input, hardware/world/target, implementations, versions/configurations, and uncertainty; never emit unqualified “fastest” or “best-in-class.”
...
- A Wart-in-Idol rewrite is a later, separate experiment. It begins only after Wart's own revision-bound, Pareto-scoped evidence establishes the exact reference subject across correctness, startup, footprint, interpreter/native throughput, compile latency, embedding, syntax/LOC, and the full loss matrix; the rewrite preserves meaning and must earn its own evidence.
- Live is tested first as context-validity, semantic coordination, and machine admission over Git/merge-queue baselines. It is not yet a replacement for Git, branches, human review, or knowledge transfer.
...
- Live replacing Git, branches, or review without measured process dominance.
