...
typedef struct {
    int32_t x;
    int32_t y;
} duo_rec_a10636e2ab520bdd;

typedef struct {
    double a;
} duo_rec_8993bd0cbb15f255;
...
static lua_Value main__lua(lua_Value _unused);
...
static inline void main() {
    int64_t z = add(P.x, P.y);
    lua_Value e = ((duo_E){ .tag = duo_E_tag_B, .as.B = {.value = ({
        lua_Value tmp = lua_table_new_with_capacity(0, 1);
        lua_table_set(tmp, lua_val_from_literal("value", 1113510858, 5), lua_val_from_int((int64_t)(z)));
        tmp;
    })} });
}
...
int main(void) {
    ...
    duo_rec_a10636e2ab520bdd P = {
        .x = 1,
        .y = 2
    };
    duo_rec_8993bd0cbb15f255 ExtP = {
        .a = 3.14
    };
    return 0;
}
