/* GENERATED — do not edit by hand. SH-03 production dispatch (bootstrap ledger).
 *
 * Source of truth:  lib/std/compiler/host.duo  (which pulls in
 *                   lib/std/compiler/lexer.duo and its dependencies)
 * Regenerate:       duo compile lib/std/compiler/host.duo --backend=c --lib \
 *                       --emit obj -o /tmp/gen.dylib   # writes /tmp/duo_host.c
 *                   cp /tmp/duo_host.c src/duo_lexer_tokenize.c
 * Consumer:         src/duo_lexer_dispatch.zig -> src/duo_lexer_bridge.zig
 *
 * WHY host.duo AND NOT lexer.duo: `--lib` never initializes the PRIMARY module,
 * so a lexer.duo artifact's exports dereference NULL. gaps/GAP-020.md.
 *
 * This file is bootstrap-ledger foreign code, sanctioned by the monoglot rule
 * as a generated OUTPUT (Pass 79 XI). It is not authored source, and the ledger
 * only shrinks: it supersedes the weak duo_keyword_classify in
 * src/duo_keyword_classify.c, which that file was written to allow.
 */
...
typedef struct {
    ...
    const char* hint_6;
    const char* hint_7;
} duo_rec_932645d4e461354e;

typedef duo_rec_932645d4e461354e duo_Lexer;
typedef struct {
    int64_t pos;
    int64_t line;
    int64_t col;
...
static inline duo_rec_932645d4e461354e std_compiler_lexer__new(const char* src, const char* file);
static lua_Value std_compiler_lexer__new__lua2(lua_Value _a0, lua_Value _a1);
static inline duo_rec_ddce63158070fd68 std_compiler_lexer__cur_loc(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__cur_loc__lua(lua_Value _a0);
static inline bool std_compiler_lexer__has_pending_hints(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__has_pending_hints__lua(lua_Value _a0);
static inline lua_Value std_compiler_lexer__consume_hints(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__consume_hints__lua(lua_Value _a0);
static inline int64_t std_compiler_lexer__peek_char(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__peek_char__lua(lua_Value _a0);
static inline int64_t std_compiler_lexer__peek_char2(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__peek_char2__lua(lua_Value _a0);
static lua_Value std_compiler_lexer__adv(duo_rec_932645d4e461354e *self);
...
static inline int64_t std_compiler_lexer__long_bracket_level(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__long_bracket_level__lua(lua_Value _a0);
static lua_Value std_compiler_lexer__skip_long(duo_rec_932645d4e461354e *self, int64_t level);
static lua_Value std_compiler_lexer__skip_long__lua2(lua_Value _a0, lua_Value _a1);
static lua_Value std_compiler_lexer__skip_ws(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__skip_ws__lua(lua_Value _a0);
static inline const char* std_compiler_lexer__read_long_str(duo_rec_932645d4e461354e *self, int64_t level);
static lua_Value std_compiler_lexer__read_long_str__lua2(lua_Value _a0, lua_Value _a1);
static inline const char* std_compiler_lexer__read_str(duo_rec_932645d4e461354e *self, int64_t quote);
static lua_Value std_compiler_lexer__read_str__lua2(lua_Value _a0, lua_Value _a1);
static inline duo_rec_59c700cbb43a8f9d std_compiler_lexer__read_num(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__read_num__lua(lua_Value _a0);
static inline duo_rec_59c700cbb43a8f9d std_compiler_lexer__next_tok(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__next_tok__lua(lua_Value _a0);
static inline duo_rec_59c700cbb43a8f9d std_compiler_lexer__next(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__next__lua(lua_Value _a0);
static inline duo_rec_59c700cbb43a8f9d std_compiler_lexer__peek(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__peek__lua(lua_Value _a0);
static inline duo_rec_2dc4845c761b63de std_compiler_lexer__save_state(duo_rec_932645d4e461354e *self);
static lua_Value std_compiler_lexer__save_state__lua(lua_Value _a0);
static lua_Value std_compiler_lexer__restore_state(duo_rec_932645d4e461354e *self, duo_rec_2dc4845c761b63de *state);
...
duo_rec_932645d4e461354e _r = std_compiler_lexer__new(_p0, _p1);
    return ({
    lua_Value _tmp = lua_table_new_with_capacity(0, 18);
...
static inline duo_rec_932645d4e461354e std_compiler_lexer__new(const char* src, const char* file) {
    ...
    return (duo_rec_932645d4e461354e){
        .src = src,
        .pos = 1,
        .line = 1,
        .col = 1,
...
static lua_Value std_compiler_lexer__skip_long(duo_rec_932645d4e461354e *self, int64_t level) {
    ...
    lua_error(lua_val_from_literal("UnterminatedLongString", 4117188040, 22));
}
...
static inline const char* std_compiler_lexer__read_str(duo_rec_932645d4e461354e *self, int64_t quote) {
    ...
    while ((self->pos <= ((int64_t)strlen(self->src)))) {
        ...
        if (((c == 10) || (c == 13))) {
            lua_error(lua_val_from_literal("UnterminatedString", 764318830, 18));
        }
        if ((c == 92)) {
            std_compiler_lexer__adv(self);
            if ((self->pos > ((int64_t)strlen(self->src)))) {
            ...
            if ((esc == 120)) {
                ...
                if (((self->pos > ((int64_t)strlen(self->src))) || (!std_compiler_lexer__is_hex(std_compiler_lexer__peek_char(self))))) {
                    lua_error(lua_val_from_literal("InvalidEscape", 2270212883, 13));
                }
                std_compiler_lexer__adv(self);
                if (((self->pos <= ((int64_t)strlen(self->src))) && std_compiler_lexer__is_hex(std_compiler_lexer__peek_char(self)))) {
                    std_compiler_lexer__adv(self);
...
static inline duo_rec_59c700cbb43a8f9d std_compiler_lexer__next_tok(duo_rec_932645d4e461354e *self) {
    ...
    if ((c == 43)) {
        ...
        lua_error(lua_val_from_literal("UnexpectedChar", 1460701410, 14));
    }
}
...
__attribute__((export_name("duo_lexer_tokenize_text"), visibility("default"))) int64_t std_compiler_lexer__duo_lexer_tokenize_text(const char* src, const char* file, int64_t out, int64_t cap, int64_t txt, int64_t txtcap) {
    duo_rec_932645d4e461354e lex = std_compiler_lexer__new(src, file);
...
static lua_Value duo_mod_std_compiler_lexer(lua_Value _unused) {
    ...
    lua_Value __duo_module = lua_table_new_with_capacity(0, 29);
