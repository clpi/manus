...
pub const Expander = struct {
    ...
    fn expandFuncBody(self: *Expander, func: ast.FuncBody, parent_ctx: ?*HygieneContext) Error!ast.FuncBody {
        ...
        return .{
            ...
            .dense_table_fill_scale = func.dense_table_fill_scale,
            .dense_table_fill_offset = func.dense_table_fill_offset,
            .use_dense_table_square_sum = func.use_dense_table_square_sum,
            .use_dense_table_fused_fill_sum = func.use_dense_table_fused_fill_sum,
            .dense_table_fill_index = func.dense_table_fill_index,
            .dense_table_fill_expr = func.dense_table_fill_expr,
            .use_dense_table_fused_dot_fill_sum = func.use_dense_table_fused_dot_fill_sum,
            .dense_table_dot_a = func.dense_table_dot_a,
            .dense_table_dot_b = func.dense_table_dot_b,
            .dense_table_dot_fill_index = func.dense_table_dot_fill_index,
            .dense_table_dot_fill_a = func.dense_table_dot_fill_a,
            .dense_table_dot_fill_b = func.dense_table_dot_fill_b,
            ...
            .dense_table_affine_mul = func.dense_table_affine_mul,
            .dense_table_affine_mod = func.dense_table_affine_mod,
