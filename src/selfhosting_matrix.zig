...
pub const subsystems: []const Subsystem = &.{
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/fmt.duo",
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/graph.duo",
        .production_status = .seed_only,
        .bootstrap_required = true,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/bind.duo",
        .production_status = .seed_only,
        .bootstrap_required = true,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/comptime.duo",
        .production_status = .seed_only,
        .bootstrap_required = true,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/rewrite.duo",
        .production_status = .porting,
        .bootstrap_required = false,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/emit_c.duo",
        .production_status = .seed_only,
        .bootstrap_required = true,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/arm64.duo",
        .production_status = .seed_only,
        .bootstrap_required = false,
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/macho.duo",
    ...
    .{
        ...
        .duo_impl = "lib/std/compiler/profile.duo",
        .production_status = .seed_only,
        .bootstrap_required = true,
