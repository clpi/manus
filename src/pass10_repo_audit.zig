...
pub const findings: []const Finding = &.{
    ...
    .{ .id = "P10-F004", .category = .historical_plan, .severity = .medium, .path = "docs/archive/pass2_convergence.md", .action = .archive, .reason = "Redirect stub → pass2_foundational_convergence.md" },
    .{ .id = "P10-F005", .category = .historical_plan, .severity = .medium, .path = "docs/archive/pass4_native_compilation.md", .action = .archive, .reason = "Redirect stub → pass4_native_end_to_end.md" },
    .{ .id = "P10-F006", .category = .historical_plan, .severity = .medium, .path = "docs/archive/pass6_reconciliation.md", .action = .archive, .reason = "Redirect stub → pass6_architectural_reconciliation.md" },
    .{ .id = "P10-F007", .category = .historical_plan, .severity = .medium, .path = "docs/archive/pass7_ai_native.md", .action = .archive, .reason = "Redirect stub → pass7_ai_native_compilation.md" },
    .{ .id = "P10-F008", .category = .historical_plan, .severity = .medium, .path = "docs/archive/pass8_persistent_semantic.md", .action = .archive, .reason = "Redirect stub → pass8_persistent_semantic_computing.md" },
...
pub const pollution_findings: []const PollutionFinding = &.{
    ...
    .{ .id = "P10-P004", .category = .historical_plan, .path = "docs/archive/pass7_ai_native.md", .tracked = true, .action = "redirect", .status = "mitigated", .rationale = "compressed to redirect stub" },
