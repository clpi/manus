...
pub const mvp_instructions: []const Instruction = &.{
    ...
    ins("wasm.f64.sub", "f64.sub", 0xA1, &.{ .f64, .f64 }, &.{.f64}, .none, "interp.f64.sub", "lower.f64.sub"),
    ins("wasm.f64.mul", "f64.mul", 0xA2, &.{ .f64, .f64 }, &.{.f64}, .none, "interp.f64.mul", "lower.f64.mul"),
    ins("wasm.f64.div", "f64.div", 0xA3, &.{ .f64, .f64 }, &.{.f64}, .none, "interp.f64.div", "lower.f64.div"),
    ...
    ins("wasm.f32.reinterpret_i32", "f32.reinterpret_i32", 0xBE, &.{.i32}, &.{.f32}, .none, "interp.f32.reinterpret_i32", "lower.f32.reinterpret_i32"),
    ...
    ins_trap("wasm.i64.load8_u", "i64.load8_u", 0x31, &.{.i32}, &.{.i64}, .mem_arg, "interp.i64.load8_u", "lower.i64.load8_u"),
