...
ledger   ext/vscode-duo/extension.js   until:the VS Code host can consume a duon projection directly; generated by scripts/vscodeemit.duo and checked by scripts/vscodeproj.duo
ledger   ext/tree-sitter-duo/grammar.js until:the tree-sitter host can consume a duon projection directly; generated by scripts/treesitter_emit.duo and checked with TSEMIT_CHECK=1
