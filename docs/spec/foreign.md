...
ledger   ext/vscode-idol/extension.js  until:the VS Code host can consume an idol projection directly; generated by scripts/vscodeemit.id and checked by scripts/vscodeproj.id
ledger   ext/tree-sitter-idol/grammar.js until:the tree-sitter host can consume an idol projection directly; generated by scripts/treesitter_emit.id and checked with TSEMIT_CHECK=1
