...
mediator controller coordinator orchestrator handler executor runner engine
pipeline scheduler loader resolver bridge shim proxy wrapper frontend backend
...
|---|---|
| dispatch / routing | subject + operands + demand + application resolution |
| registration | anchored semantic facts in the graph |
