...
`docs/plans/pass*.md` are **HISTORICAL EVIDENCE**. They record how the design
arrived where it is. They are NOT architecture inputs, and nothing may cite them
as authority.
...
- [ ] every `.duo` corpus file classified
      ...
      rewriting deliberate compatibility fixtures
