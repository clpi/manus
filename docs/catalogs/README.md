...
| --- | --- | --- |
| Keywords (53) | [`keywords.md`](keywords.md) | `keywords` |
| Directives (~130) | [`directives.md`](directives.md) | `comp_paths`, `tier1_directives` |
...
and `src/pass3_catalog.zig` together when classifications change.
