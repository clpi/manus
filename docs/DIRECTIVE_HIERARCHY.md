...
4. **Expression combinators**: `@comp.map`, `@comp.match`, `@comp.tabulate`, `@comp.grammar`, `@comp.template`, `@comp.generate`, `@comp.scheme`, `@comp.scheme.clauses`, `@comp.weave`, `@comp.each`.
...
| --- | --- | --- |
| Linear | `@comp.map`, `@comp.template`, `@comp.generate`, `@comp.scheme`, `@comp.match`, `@comp.tabulate` | O(n) |
