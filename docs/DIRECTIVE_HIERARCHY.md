...
4. **Expression combinators**: `@comp.map`, `@comp.match`, `@comp.tabulate`, `@comp.interpolate`, `@comp.grammar`, `@comp.template`, `@comp.generate`, `@comp.scheme`, `@comp.scheme.clauses`, `@comp.weave`, `@comp.each`.
