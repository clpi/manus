...
IDOL_GATES='gate/table_apply.id gate/canonicality.id gate/readpath.id gate/gap-111-map-ambiguity.id gate/gap-111-subject-first.id gate/gap-118-env-absence.id gate/perfmonotone.id gate/grammar-projection.id'
